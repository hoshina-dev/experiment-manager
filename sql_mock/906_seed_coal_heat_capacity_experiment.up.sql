  ...
  jsonb_set(
    ...
    '{
      ...
      "userForm": {
        ...
        "questions": [
          { "id": "sample_id",            "type": "string", "label": "Sample ID",                    "required": true, "default": "CHR-001",    "value": "CHR-2024-047" },
          { "id": "sample_source",        "type": "string", "label": "Source / Grade",               "required": true, "default": "Activated charcoal sample", "value": "Activated coconut charcoal, 99.5% purity (Sigma-Aldrich #C9157)" },
          { "id": "sample_mass",          "type": "string", "label": "Sample mass (g)",              "required": true, "default": "1.0000",     "value": "1.2340" },
          { "id": "temperature_initial",  "type": "string", "label": "Initial temperature (°C)",    "required": true, "default": "25.00",      "value": "24.82" },
          { "id": "temperature_final",    "type": "string", "label": "Final temperature (°C)",      "required": true, "default": "30.00",      "value": "30.17" },
          { "id": "calorimeter_constant", "type": "string", "label": "Calorimeter constant (J/°C)", "required": true, "default": "9800.0",     "value": "9845.0" }
        ]
      },
      "workerForm": {
        ...
        "questions": [
          { "id": "analyst_name",  "type": "string", "label": "Analyst name",     "default": "Analyst",          "value": "Dr. Pornpun Kittipanya" },
          { "id": "lab_id",        "type": "string", "label": "Laboratory ID",    "default": "LAB-001",          "value": "TH-CHEM-LAB-03" },
          { "id": "analysis_date", "type": "string", "label": "Analysis date",    "default": "YYYY-MM-DD",       "value": "2024-11-14" },
          { "id": "instrument",    "type": "string", "label": "Instrument",       "default": "Bomb Calorimeter", "value": "Parr 6200 Isoperibol Calorimeter" },
          { "id": "method_ref",    "type": "string", "label": "Method reference", "default": "ASTM D5865",       "value": "ASTM D5865 / ISO 1928" }
        ]
      },
      "calculations": {
        "delta_T":             "5.35",
